...
# # List of basic Python keywords (you can add more later)
# keywords = [
#     "def", "class", "import", "from", "for", "while", "if", "else",
#     "elif", "try", "except", "return", "with", "as", "lambda",
#     "True", "False", "None", "print", "input", "int", "str", "float"
# ]

# def get_suggestions(prefix):
#     # Return suggestions that start with the typed prefix
#     return [word for word in keywords if word.startswith(prefix)]
# autocomplete.py
import json
